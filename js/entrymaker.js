window.addEventListener('DOMContentLoaded', function() {
  ...
  entryForm.validateButton.addEventListener('click', showResult);
	...
	$.getJSON('http://specref.jit.su/bibrefs', pupulateDatalists);

	function pupulateDatalists(data) {
			createSpecTitleOptions(entryForm.spectitle.list, data);
			createHREFOptions(entryForm.href.list, data);
			createEntryOptions(entryForm.entryid.list, data);
	}
